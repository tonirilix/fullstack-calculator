  ...
  return (
    <div className="rounded-[2rem] border border-stone-700 bg-stone-950 px-5 py-5 text-stone-50 shadow-[inset_0_2px_16px_rgba(255,255,255,0.08)]">
      <div
        ...
        className="min-h-16 overflow-x-auto text-right font-mono text-4xl tracking-tight whitespace-nowrap sm:text-5xl"
      >
        {displayValue}
      </div>
      <div className="mt-3 min-h-5 text-right text-xs tracking-[0.18em] text-stone-400 uppercase">
        {errorMessage ? (
